                            ...
                            if (circle.y > this.center.y) {
                                    ...
                                    while (this.shape.doesPerimeterTouch(circle)) {
                                        ...
                                        if (circle == circle.self.body) {
                                            ...
                                            if (circle == circle.self.lefthand || circle == circle.self.lefthand2 || circle == circle.self.lefthand3) {
                                                if (circle.self.leftarm.sqrDis() < (this.height * 5.2)* (this.height * 5.2)) {
                                                    circle.y += .1
                                                    if (circle.doesPerimeterTouch(this.edgeleft)) {
                                                        if (circle == circle.self.righthand) {
                                                            if (circle.anchored >= -1) {
                                            ...
                                            if (circle == circle.self.righthand || circle == circle.self.righthand2 || circle == circle.self.righthand3) {
                                                if (circle.self.rightarm.sqrDis() < (this.height * 5.2)*(this.height * 5.2)) {
                                                    circle.y += .1
                                                    if (circle.doesPerimeterTouch(this.edgeleft)) {
                                                        if (circle == circle.self.righthand) {
                                                            if (circle.anchored >= -1) {
                                ...
                                while (this.shape.doesPerimeterTouch(circle)) {
                                    ...
                                    if (circle == circle.self.body) {
                                        ...
                                        if (circle == circle.self.lefthand || circle == circle.self.lefthand2 || circle == circle.self.lefthand3) {
                                            if (circle.self.leftarm.sqrDis() < (this.height * 15.2)* (this.height * 15.2)) {
                                                if (circle.self.body.y <= this.edgeleft.y) {
                                                    if (circle.anchored != 1) {
                                                        circle.y -= .1
                                        ...
                                        if (circle == circle.self.righthand || circle == circle.self.righthand2 || circle == circle.self.righthand3) {
                                            if (circle.self.rightarm.sqrDis() < (this.height * 15.2)*(this.height * 15.2)) {
                                                if (circle.self.body.y <= this.edgeleft.y) {
                                                    if (circle.anchored != 1) {
                                                        circle.y -= .1
                        ...
                        if (boys[t].shots[k].marked != 1) {
                            if (boys[t].shots[k].doesPerimeterTouch(this.body)) {
                                ...
                                if (this.shield == 1) {
                                    ...
                                    this.body.xmom = ((boys[t].shots[k].xmom * (this.damage / 121)) + (boys[t].shots[k].xmom * (baselaunch*2.7))) * 2
                                    this.body.ymom = (((boys[t].shots[k].ymom * (this.damage / 121)) + (boys[t].shots[k].ymom * (baselaunch*2.7))) * 2) - (10 * (this.damage / 121))
                                    this.damage += (Math.abs(boys[t].shots[k].xmom) + Math.abs(boys[t].shots[k].ymom)) / 2
                                    this.breaktimer = 0
                                }
                                boys[t].shots[k].marked = 1
                        ...
                        if (boys[t].righthands2.doesPerimeterTouch(this.body) || boys[t].righthand2.doesPerimeterTouch(this.body)) {
                            ...
                            if (boys[t].righthand2.fired > 14) {
                                if (this.shield == 1) {
                                    ...
                                    this.body.xmom = .4567 * ((boys[t].righthand2.xmom * (this.damage / 121)) + (boys[t].righthand2.xmom * (baselaunch*2.7))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.body.ymom = .4567 * (((boys[t].righthand2.ymom * (this.damage / 121)) + (boys[t].righthand2.ymom * (baselaunch*2.7))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.damage += .4567 * ((Math.abs(boys[t].righthand2.xmom) + Math.abs(boys[t].righthand2.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.breaktimer = 0
                                }
                                boys[t].righthand2.fired = 14
                        ...
                        if (boys[t].lefthands2.doesPerimeterTouch(this.body) || boys[t].lefthand2.doesPerimeterTouch(this.body)) {
                            ...
                            if (boys[t].lefthand2.fired > 14) {
                                if (this.shield == 1) {
                                    ...
                                    this.body.xmom = .4567 * ((boys[t].lefthand2.xmom * (this.damage / 121)) + (boys[t].lefthand2.xmom * (baselaunch*2.7))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.body.ymom = .4567 * (((boys[t].lefthand2.ymom * (this.damage / 121)) + (boys[t].lefthand2.ymom * (baselaunch*2.7))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.damage += .4567 * ((Math.abs(boys[t].lefthand2.xmom) + Math.abs(boys[t].lefthand2.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.breaktimer = 0
                                }
                                boys[t].lefthand2.fired = 14
                        ...
                        if (boys[t].righthands3.doesPerimeterTouch(this.body) || boys[t].righthand3.doesPerimeterTouch(this.body)) {
                            ...
                            if (boys[t].righthand3.fired > 14) {
                                if (this.shield == 1) {
                                    ...
                                    this.body.xmom = .4567 * ((boys[t].righthand3.xmom * (this.damage / 121)) + (boys[t].righthand3.xmom * (baselaunch*2.7))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.body.ymom = .4567 * (((boys[t].righthand3.ymom * (this.damage / 121)) + (boys[t].righthand3.ymom * (baselaunch*2.7))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.damage += .4567 * ((Math.abs(boys[t].righthand3.xmom) + Math.abs(boys[t].righthand3.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.breaktimer = 0
                                }
                                boys[t].righthand3.fired = 14
                        ...
                        if (boys[t].lefthands3.doesPerimeterTouch(this.body) || boys[t].lefthand3.doesPerimeterTouch(this.body)) {
                            ...
                            if (boys[t].lefthand3.fired > 14) {
                                if (this.shield == 1) {
                                    ...
                                    this.body.xmom = .4567 * ((boys[t].lefthand3.xmom * (this.damage / 121)) + (boys[t].lefthand3.xmom * (baselaunch*2.7))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.body.ymom = .4567 * (((boys[t].lefthand3.ymom * (this.damage / 121)) + (boys[t].lefthand3.ymom * (baselaunch*2.7))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.damage += .4567 * ((Math.abs(boys[t].lefthand3.xmom) + Math.abs(boys[t].lefthand3.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                    this.breaktimer = 0
                                }
                                boys[t].lefthand3.fired = 14
                    ...
                    if (boys[t].righthands.doesPerimeterTouch(this.body) || boys[t].righthand.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].righthand.fired > 14) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = ((boys[t].righthand.xmom * (this.damage / 121)) + (boys[t].righthand.xmom * (baselaunch*2.7))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.body.ymom = (((boys[t].righthand.ymom * (this.damage / 121)) + (boys[t].righthand.ymom * (baselaunch*2.7))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.damage += ((Math.abs(boys[t].righthand.xmom) + Math.abs(boys[t].righthand.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.breaktimer = 0
                            }
                            boys[t].righthand.fired = 14
                        ...
                        if (boys[t].lefthand.fired > 14) {
                            ...
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = (boys[t].lefthand.xmom * (this.damage / 121)) + (boys[t].lefthand.xmom * (baselaunch*2.7))
                                this.body.ymom = (((boys[t].lefthand.ymom * (this.damage / 121)) + (boys[t].lefthand.ymom * (baselaunch*2.7))) * 1)
                    ...
                    if (boys[t].screwangle != 0 && boys[t].body.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].body.fired > 0) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = (boys[t].body.xmom * (this.damage / 121)) + (boys[t].body.xmom * (baselaunch*2.7)) * 2
                                this.body.ymom = (((boys[t].body.ymom * (this.damage / 121)) + (boys[t].body.ymom * (baselaunch*2.7))) * 2)
                                this.damage += (Math.abs(boys[t].body.xmom) + Math.max(20, Math.abs(boys[t].body.ymom))) / 2
                            }
                            boys[t].body.fired = 0
                            if (this.righthand.anchored == 1 || this.lefthand.anchored == 1) {
